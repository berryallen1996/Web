        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="panel">
                    ...
                    <form role="form" method="post" enctype="multipart/form-data" action="{{ url('admin/restaurant/'.$restaurant->id)}}">
                        <input type="hidden" name="_method" value="PUT">
                        {{ csrf_field() }}
                        <div class="panel-body">
                            <div class="form-group @if ($errors->has('name'))has-error @endif">
                                <label for="name">Restaurant Name</label>
                                <input type="text" class="form-control" name="name" placeholder="Quantity Name" value="{{ (old('name')) ? (old('name')) : $restaurant->name }}">
                        ...
                        <div class="panel-body">
                            <div class="form-group @if ($errors->has('address'))has-error @endif">
                                ...
                                <input type="text" class="form-control" name="address" placeholder="Restaurant address" value="{{ (old('address')) ? (old('address')) : $restaurant->address }}">
                        ...
                        <div class="panel-body">
                            <div class="form-group @if ($errors->has('contact_no'))has-error @endif">
                                ...
                                <input type="text" class="form-control" name="contact_no" placeholder="Mobile Number" value="{{ (old('contact_no')) ? (old('contact_no')) : $restaurant->contact_no }}">
                        ...
                        <div class="panel-body">
                            <div class="form-group @if ($errors->has('state'))has-error @endif">
                                ...
                                <select name="state" id="state" class="form-control" style="width:350px">
                                    <option value="{{$restaurant->state_id}}" selected="selected">{{$restaurant->states}}</option>
                                </select>
                        ...
                        <div class="panel-body">
                            <div class="form-group @if ($errors->has('city'))has-error @endif">
                                ...
                                <select name="city" id="city" class="form-control" style="width:350px">
                                    <option value="{{$restaurant->city_id}}" selected="selected">{{$restaurant->city_name}}</option>
                                </select>
                        ...
                        <div class="panel-body">
                            <div class="form-group @if ($errors->has('locality'))has-error @endif">
                                ...
                                <select name="locality" id="locality" class="form-control" style="width:350px">
                                    <option value="{{$restaurant->locality_id}}" selected="selected">{{$restaurant->locality_name}}</option>
                                </select>
                        ...
                        <div class="panel-body">
                            <div class="form-group @if ($errors->has('pincode'))has-error @endif">
                                ...
                                <input type="text" class="form-control" name="pincode" placeholder="Pincode" value="{{ (old('pincode')) ? (old('pincode')) : $restaurant->pincode }}">
                        ...
                        @if ($restaurant->image)
                            <div class="form-group @if ($errors->has('image'))has-error @endif">
                              ...
                              <span>
                                <img src="{{$restaurant->image}}" class="custom-image" id="pre_image">
                              </span>
                            </div>
                        @endif
                        <div class="panel-body">
