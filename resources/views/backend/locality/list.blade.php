           ...
           columnDefs: [
               ...
               },
               {
                   ...
                   "render": function (data) {
                      var link = '<a href="locality/'+data['locality_id']+'/edit" class="badge bg-light-blue" title="Edit">Edit</a><a href="javascript:void(0);" data-url="locality/'+data['locality_id']+'" data-request="status" data-ask="Do you really want to continue with this action?" class="badge bg-red" title="Delete">Delete</a>';
                      return link;
                    }
               }
           ],
